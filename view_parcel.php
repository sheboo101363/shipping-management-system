...
// جلب اسم المندوب
$courier_name = "";
if(isset($courier_id) && $courier_id > 0){
  $courier = $conn->query("SELECT name FROM couriers WHERE id = '$courier_id'")->fetch_assoc();
			...
			<div class="col-md-6">
				<div class="callout callout-info">
					...
					<dl>
						...
						<?php endif; ?>
						<!-- عرض اسم المندوب -->
						<dt>المندوب المسؤول:</dt>
						<dd><?php echo $courier_name ? ucwords($courier_name) : "<span class='text-danger'>لم يتم تعيين مندوب!</span>"; ?></dd>
						<!-- /عرض اسم المندوب -->
						<dt>Status:</dt>
						<dd>
							<?php 
